            ...
            <el-table class="usertable" :data="userlist" stripe>
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                            <el-button type="primary" @click="chat(scope.row.name,scope.row.id)">开始聊天</el-button>
                        </el-tooltip>
                    </template>
                </el-table-column>
            </el-table>
    ...
    export default {
        ...
        methods: {
            async getUserList() {
                ...
                if(Response.msg=="Ok"){
                    this.userlist=Response.data.friends;
            ...
            chat(name,id) {
                window.sessionStorage.setItem('receiver', id);
                window.sessionStorage.setItem('receiverName', name);
                window.sessionStorage.setItem('group', '');
                window.sessionStorage.setItem('type', "私聊聊天室");
